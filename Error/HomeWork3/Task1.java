...
//  с информацией, что именно неверно. Если всё введено и обработано верно, должен создаться файл с названием,
...
public class Task1 {
    ...
    public static void makeRecord() throws Exception {
        System.out.println("Введите фамилию, имя, отчество, дату рождения (dd.mm.yyyy), " +
                "номер телефона и пол(f или m), разделенные пробелом");
        ...
        if (array.length > 6) {
            ...
            throw new Exception("Введено не достаточно данных");
        }
